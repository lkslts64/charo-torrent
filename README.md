...
client. The [torrent package](https://godoc.org/github.com/lkslts64/charo-torrent/torrent) is very simple to use and can be used as a library by other projects. Aside from the [core protocol specification](https://www.bittorrent.org/beps/bep_0003.html), charo implements:
...
2. Client: `go get https://github.com/lkslts64/charo-torrent/cmd/charo-download`
